...
return [
    ...
    */
     ...
     */
    'constants' => [
        'SWAGGER_LUME_CONST_HOST_TOKEN' => env('SWAGGER_LUME_CONST_HOST_TOKEN', 'http://localhost:8000/account-api/oauth/token'),
        'SWAGGER_LUME_CONST_TITLE' => env('SWAGGER_LUME_CONST_TITLE', 'Pegasus Untitled API'),
        'SWAGGER_LUME_CONST_VERSION' => env('SWAGGER_LUME_CONST_VERSION', '1.0'),
    ],
